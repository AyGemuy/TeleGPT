...
${Object.keys(listGpt).map((key, index) => `${index + 1}. ${key.toLowerCase()}`).join('\n')}
`
...
${Object.keys(listAi).map((key, index) => `${index + 1}. ${key.toLowerCase()}`).join('\n')}
`
    await lol.editMessageText(text, {
        reply_markup: {
            inline_keyboard: [
...
${Object.keys(listDown).map((key, index) => `${index + 1}. ${key.toLowerCase()}`).join('\n')}
`
    await lol.editMessageText(text, {
        reply_markup: {
            inline_keyboard: [
...
${Object.keys(listRandom).map((key, index) => `${index + 1}. ${key.toLowerCase()}`).join('\n')}

${Object.keys(listCarbon).map((key, index) => `${index + 1}. ${key.toLowerCase()}`).join('\n')}
`
    await lol.editMessageText(text, {
        reply_markup: {
            inline_keyboard: [
...
${Object.keys(listInfo).map((key, index) => `${index + 1}. ${key.toLowerCase()}`).join('\n')}
`
    await lol.editMessageText(text, {
        reply_markup: {
            inline_keyboard: [
...
${Object.keys(listSearch).map((key, index) => `${index + 1}. ${key.toLowerCase()}`).join('\n')}
`
    await lol.editMessageText(text, {
        reply_markup: {
            inline_keyboard: [
...
${Object.keys(listUpload).map((key, index) => `${index + 1}. ${key.toLowerCase()}`).join('\n')}
`
    await lol.editMessageText(text, {
        reply_markup: {
            inline_keyboard: [
